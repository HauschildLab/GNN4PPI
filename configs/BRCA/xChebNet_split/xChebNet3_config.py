# Created by julia at 02.01.2026
from configs.BRCA import main_fairpact_scratch_config
import os

config = main_fairpact_scratch_config.config
search_space = main_fairpact_scratch_config.search_space

# Model and Experiment
config['model_name'] = 'ChebNet'
config['experiment_name'] = 'Split_3'
config['project_name'] = 'xChebNet'
...
#################################
search_space['dataset_test_round']=[3]
#################################
