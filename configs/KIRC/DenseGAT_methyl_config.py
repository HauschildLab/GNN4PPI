...
from configs.KIRC import main_config
import os
...
config['project_name'] = 'mDenseGAT_v5'

# Resources (GPU,CPU)
# GGPU (A100)
config['resources_per_worker'] = {"CPU": 15, "GPU": 1}
...
# Hyperparameters
search_space['learning_rate'] = [0.1,  0.01, 0.001]
...
# Directories
config['data_dir'] = '/mnt/vast-orga/user/{username}/gnn-for-ppi-final/data' # data directory for whole KIRC dataset
config['checkpoint_dir'] = '/mnt/vast-orga/user/{username}/gnn-for-ppi-final/GAT_a100/checkpoints'
config['result_dir'] = '/mnt/vast-orga/user/{username}/gnn-for-ppi-final/GAT_a100/results'
config['comet_dir'] = '/mnt/vast-orga/user/{username}/gnn-for-ppi-final/GAT_a100/comet_logs'
config['data_split_file'] = 'data_splits_KIRC.pt'
