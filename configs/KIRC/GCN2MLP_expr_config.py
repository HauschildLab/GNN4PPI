...
config['model_name'] = 'GCN2MLP'
config['experiment_name'] = 'Final_run_HPC'
config['project_name'] = 'xGCN2MLP'
...
search_space['weight_decay'] = [0.0001, 0.001, 0.01]
search_space['dropout_rate'] = [0,  0.2, 0.4]  # 0 = no dropout, dropout_rate = prob. for removing neuron

# Directories
config['data_dir'] = '/user/{username}/gnn-for-ppi-hiwi/data' # data directory for whole KIRC dataset
config['checkpoint_dir'] = '/user/{username}/gnn-for-ppi-hiwi/NHR/KIRC/checkpoints'
config['result_dir'] = '/user/{username}/gnn-for-ppi-hiwi/NHR/KIRC/results'
config['comet_dir'] = '/user/{username}/gnn-for-ppi-hiwi/NHR/KIRC/comet_logs'
