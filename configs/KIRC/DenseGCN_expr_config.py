...
config['project_name'] = 'xDenseGCN_v5'

# Resources (GPU,CPU)
# AGQ
config['resources_per_worker'] = {"CPU": 7, "GPU": 1}
...
# Directories
config['data_dir'] = '/scratch-scc/projects/{username}/data' # data directory for whole KIRC dataset
config['checkpoint_dir'] = '/scratch-scc/projects/{username}/GNN4PPI/checkpoints'
config['result_dir'] = '/scratch-scc/projects/{username}/GNN4PPI/results'
config['comet_dir'] = '/scratch-scc/projects/{username}/GNN4PPI/comet_logs'
