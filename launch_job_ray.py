...
# source: https://docs.ray.io/en/latest/cluster/vms/user-guides/community/slurm-launch.html#slurm-launch
...
template_file = Path(__file__).parent / "job_ray_template.sh"
JOB_NAME = "${JOB_NAME}"
NUM_NODES = "${NUM_NODES}"
