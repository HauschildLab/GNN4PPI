...
config = {
    ...
    'checkpoint_dir': "/user/{username}/GNN4PPI/NHR/KIRC/checkpoints",
    'result_dir': "/user/{username}/GNN4PPI/NHR/KIRC/results",
    'comet_dir': "/user/{username}/GNN4PPI/NHR/KIRC/comet_logs",
