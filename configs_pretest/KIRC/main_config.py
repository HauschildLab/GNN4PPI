...
config = {
    ...
    ################
    # Scratch directory
    'data_dir': "/scratch/projects/{username}/data",    # data directory for whole KIRC dataset
    'checkpoint_dir': "/scratch/projects/{username}/GNN4PPI/checkpoints",
    'result_dir': "/scratch/projects/{username}/GNN4PPI/results",
    'comet_dir': "/scratch/projects/{username}/GNN4PPI/comet_logs",
