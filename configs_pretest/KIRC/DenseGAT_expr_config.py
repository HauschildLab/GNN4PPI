...
from configs_pretest.KIRC import main_home_config
import os

config = main_home_config.config
search_space = main_home_config.search_space

# Model and Experiment
config['model_name'] = 'GAT'
config['experiment_name'] = 'FinalTest_HPC_full_corr'
config['project_name'] = 'Test_DenseGAT_v4_expr'
